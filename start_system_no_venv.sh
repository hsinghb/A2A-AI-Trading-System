...
echo "🤖 Starting AI Trading System (system Python, --user install, no venv)..."
echo "=================================="
...
install_requirements() {
    echo "📥 Installing/updating requirements with --user (no venv)..."
...
# Always install/update requirements with --user
install_requirements || {
    echo "❌ Failed to install requirements"
    exit 1
}
...
echo ""
echo "🎉 AI Trading System is now running! (system Python, --user install, no venv)"
echo "=================================="
echo "📱 Access URLs:"
